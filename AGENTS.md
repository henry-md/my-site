...
- agent-docs/architecture/  
  Explains h the codebase is structured and how major systems interact. Use this to understand where new code should live and how components connect. Example files: architecture/overview.md, architecture/database.md, architecture/api.md, architecture/auth.md.
